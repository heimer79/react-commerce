  ...
  return (
    ...
    <div className="bg-white cursor-pointer w-56 h-60 rounded-lg">
        <figure className="relative mb-2 w-full h-4/5">
            ...
            <img className="w-full h-full object-cover rounded-lg" src="https://images.pexels.com/photos/8000624/pexels-photo-8000624.jpeg?auto=compress&cs=tinysrgb&w=600" alt="headphones" />
        ...
        <p className="flex justify-between">
            ...
            <span className="text-lm font-medium" >$300</span>
        </p>
    </div>
